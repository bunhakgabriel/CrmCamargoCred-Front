...
import { bancosOptions, beneficiosOptions, conveniosOptions, enderecoCorrespondenciaOptions, estadoCivilOptions, grauInstrucaoOptions, sexoOptions, tipoContaOptions, ufOptions, type OptionSelect } from "./data/data";
